  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Indicator width should be roughly half of the container width minus padding
        double indicatorWidth = (width / 2) - 4; 

        return Container(
          height: 50,
          padding: const EdgeInsets.all(4), // track padding
